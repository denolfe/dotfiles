...
() {
  ...
  #
  typeset -g POWERLEVEL9K_ASDF_NODEJS_SHOW_ON_UPGLOB='*.ts|*.js|package.json'
  ...
  # Pnpm version from asdf.
  # typeset -g POWERLEVEL9K_ASDF_PNPM_FOREGROUND=0
  typeset -g POWERLEVEL9K_ASDF_PNPM_BACKGROUND=214
  typeset -g POWERLEVEL9K_ASDF_PNPM_VISUAL_IDENTIFIER_EXPANSION=$'\ue865'
  # typeset -g POWERLEVEL9K_ASDF_PNPM_SHOW_ON_UPGLOB='*.foo|*.bar'
  ...
  #####################################[ yarn_link: custom yarn_link segment ]#########################

  typeset -g POWERLEVEL9K_YARN_LINK_FOREGROUND=0
