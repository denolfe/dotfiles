...
**Personal skills live in agent-specific directories (`~/.pi/agent/skills` for Pi, `~/.agents/skills/` for Codex)**
...
**The trap:** Descriptions that summarize workflow create a shortcut the agent will take. The skill body becomes documentation Claude skips.
